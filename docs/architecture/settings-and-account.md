...
`docs/architecture/posts-and-feed.md`). /notifications shows the feed's own
cards, so these counts apply there too; its separate quote length
(`:notification_post_lines`) was retired with the 2026-09 rebuild.
