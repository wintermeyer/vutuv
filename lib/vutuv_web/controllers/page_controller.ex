defmodule VutuvWeb.PageController do
  ...
  - `/<username>/<section>` — the profile sections in full: `work_experiences`,
    `educations`, `languages`, `links`, `social_media_accounts`, `addresses`,
    `phone_numbers`, `emails` (public addresses only), `tags`; a single entry
    lives at `/<username>/<section>/<id-or-slug>`
