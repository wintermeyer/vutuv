  ...
  defp section_icon(assigns) do
    ...
    >
      <%= case @name do %>
        ...
        <% "ticket" -> %>
          <path d="M3.5 8.5V6.8a1.3 1.3 0 0 1 1.3-1.3h14.4a1.3 1.3 0 0 1 1.3 1.3v1.7a2.6 2.6 0 0 0 0 7v1.7a1.3 1.3 0 0 1-1.3 1.3H4.8a1.3 1.3 0 0 1-1.3-1.3v-1.7a2.6 2.6 0 0 0 0-7Z" />
          <path d="M14 8.5v1.4M14 14.1v1.4" />
        <% "medal" -> %>
