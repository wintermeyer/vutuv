defmodule Vutuv.Accounts.ReservedSlugs do
  ...
  @route_slugs ~w(
    ...
    notifications nutzungsbedingungen oauth phoenix post_images post_videos job_posting_images posts press privacy reports review_covers robots.txt
    screenshots search search_queries security.txt sent_emails sessions settings site.webmanifest
