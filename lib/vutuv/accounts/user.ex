defmodule Vutuv.Accounts.User do
  ...
  schema "users" do
    ...
    # How many likes of one post may still interrupt this member before they go
    # quiet ("25".."1000", or "none" for no cap), see
    # `Vutuv.Activity.LikeThrottle`. nil = inherit the installation default;
    # read through `Vutuv.Prefs.like_notification_cap/1`.
    field(:like_notification_cap, :string)
  ...
  def changeset(model, params \\ %{}) do
    ...
    |> validate_inclusion(:like_notification_cap, Prefs.pref!(:like_notification_cap).values)
