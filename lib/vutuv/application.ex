  ...
  def start(_type, _args) do
    ...
    children =
      [
        ...
        optional_child(:sweep_ad_sightings, Vutuv.Ads.SightingSweeper) ++
        ...
        optional_child(:pending_sweeper, Vutuv.Posts.PendingSweeper) ++
        ...
        optional_child(:signup_trap_report, Vutuv.SignupTrap.Reporter) ++
