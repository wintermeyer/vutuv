defmodule Vutuv.Companies.CompanyDomain do
  @moduledoc """
  A verified (or being-verified) domain of a company (issue #929). The unique
  `domain` column is the anti-squatting anchor: one domain belongs to exactly
  one company. Domain identity is the **exact host** (`sub.example.com` and
