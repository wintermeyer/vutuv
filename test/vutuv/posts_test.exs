defmodule Vutuv.PostsTest do
  ...
  # A helper for the tests that need a post with real reception behind it: the
  # likes come from distinct strangers, so nothing here rests on a self-like.
  defp liked!(post, likers) do
